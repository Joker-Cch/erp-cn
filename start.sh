...
if [ -f /app/nginx.conf ]; then
    ...
    content=$content'    add_header Access-Control-Allow-Origin * always;\n'
    content=$content'    add_header Access-Control-Allow-Headers "Content-Type, Authorization" always;\n'
    content=$content'    add_header Access-Control-Allow-Methods "GET,POST,OPTIONS,PUT,PATCH,DELETE,HEAD" always;\n'
